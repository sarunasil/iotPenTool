...
class MainGui(QtWidgets.QMainWindow, Ui_MainWindow):
	...
	def __init__(self, interfaces, manager, threat_model):
		...
		self.tool_menu = TabWidget()
		self.tool_menu.setMaximumWidth(500)
		for name, interface in interfaces.items():
			...
			self.tool_menu.addTab(interface.gui_controller.modulegui, name) #adds generated guis to TabWidget

			# self.resized.connect(interface.gui.print_general_size)
		self.module_bar.layout().addWidget(self.tool_menu)
